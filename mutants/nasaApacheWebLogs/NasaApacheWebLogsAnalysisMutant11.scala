...
object NasaApacheWebLogsAnalysis {
  ...
  def sameHostProblem(firstLogs: RDD[String], secondLogs: RDD[String]): RDD[String] = {
    ...
    val intersection: RDD[String] = firstHosts.union(secondHosts) // BTS - Binary Transformations Swap
  ...
  def unionLogsProblem(firstLogs: RDD[String], secondLogs: RDD[String]): RDD[String] = {
    val aggregatedLogLines: RDD[String] = firstLogs.intersection(secondLogs) // BTS - Binary Transformations Swap
