...
object MoviesRecommendation {
  ...
  def moviesSimilaritiesTable(inputRDD: RDD[String]): RDD[((Int, Int), (Double, Int))] = {
    ...
    val selfJoinRatings: RDD[(Int, ((Int, Double), (Int, Double)))] = ratings.rightOuterJoin(ratings).map(x => (x._1, (x._2._1.getOrElse(null), x._2._2))) // JTR - Join Transformation Replacement
