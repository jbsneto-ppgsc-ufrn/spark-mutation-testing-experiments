...
object MoviesRecommendation {
  ...
  def moviesSimilaritiesTable(inputRDD: RDD[String]): RDD[((Int, Int), (Double, Int))] = {
    ...
    val selfJoinRatings: RDD[(Int, ((Int, Double), (Int, Double)))] = ratings.leftOuterJoin(ratings).map(x => (x._1, (x._2._1, x._2._2.getOrElse(null)))) // JTR - Join Transformation Replacement
